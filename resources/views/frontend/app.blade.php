				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						...
						<div class="block2-pic hov-img0">
							<img src="{{asset('product/' . $pro->image  )}}" alt="IMG-PRODUCT">
						
      
							<a href="{{route('cart.show',$pro->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 ">
								Quick View
							</a>
						</div>
